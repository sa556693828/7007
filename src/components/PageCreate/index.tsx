...
export default function Create() {
  ...
  const imgArrayM = [
    ...
    },
    {
      ...
      after: "top-[40%] -right-[8%] rotate-0 z-10",
      width: 90,
    },
    {
      pic: art,
      ...
      after: "bottom-[38%] -left-[7%] z-10 rotate-0",
      width: 95,
    },
    {
      pic: NFT,
      ...
      after: "bottom-[27%] right-[0%] rotate-0",
      width: 90,
    },
    {
      pic: ownership,
      ...
      after: "bottom-[23%] z-10 left-[10%] rotate-0",
      width: 181,
    },
    {
      pic: tokens,
      alt: "tokens",
      before: "bottom-[42%] right-[32%] -rotate-[70deg]",
      after: "bottom-[19%] right-[24%] rotate-0",
      width: 90,
    },
  ];
