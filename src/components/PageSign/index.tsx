...
export default function Sign() {
  ...
  return (
    <div className="z-20 flex h-full min-h-[100dvh] w-full flex-col items-center gap-[5%] bg-white pb-[90px] pt-40 dark:bg-bgGrey lg:min-h-[100dvh] lg:flex-row lg:items-start lg:pl-[14%] lg:pt-[180px]">
